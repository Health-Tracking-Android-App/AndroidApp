package project.st991488104.krutik.fragments.update
...
import project.st991488104.krutik.databinding.FragmentUpdateBinding
        ...
        private fun updateItem() {
            ...
            if (validation) {
                ...
                val updatedItem = ToDoData(
                    args.currentItem.taskId,
                    title,
                    mSharedViewModel.parsePriority(getPriority),
                    description,
                    args.currentItem.exerciseId
                )
